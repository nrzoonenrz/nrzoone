        ...
        <div className="min-h-screen bg-premium-light font-bengali text-premium-dark overflow-x-hidden">
            ...
            <section className="relative pt-24 pb-12 md:pt-32 md:pb-24 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        <div className="relative rounded-lg overflow-hidden shadow-sm border-4 border-white">
                            <img loading="lazy" src={currentHeroImage} alt="NR Zone Hero" className="w-full h-auto object-cover transform hover:scale-105 transition-transform duration-700" />
                            <div className="absolute bottom-6 left-6 right-6 glass-morphism p-4 rounded flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-[#111827] dark:text-white text-xl font-bold text-premium-gold">১৬৮০ ৳ <span className="text-sm line-through text-gray-400 ml-2">১৯৯০ ৳</span></p>
                                </div>
            ...
            <section id="products" className="py-20 px-4 md:px-6 bg-gray-50 dark:bg-[#09090B]">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 space-y-4">
                        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white">মা-মেয়ে স্পেশাল কম্বো</h2>
                                ...
                                >
                                    ...
                                    <div className="p-6 space-y-5 flex-1 flex flex-col">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                <option className="bg-white text-black dark:bg-[#2A2A2E] dark:text-white" value="combo">ফুল কম্বো সেট (মা+মেয়ে)</option>
                                                <option className="bg-white text-black dark:bg-[#2A2A2E] dark:text-white" value="ma_single">সিঙ্গেল বোরকা (মা)</option>
                                                <option className="bg-white text-black dark:bg-[#2A2A2E] dark:text-white" value="baby_single">সিঙ্গেল বোরকা (বাচ্চা)</option>
                                            </select>
                                        </div>
                        ...
                        <div className="flex-1 p-6 md:p-8 space-y-6 overflow-y-auto custom-scrollbar">
                            ...
                            <div className="bg-slate-50 p-4 rounded-xl space-y-2 border border-slate-100 text-sm dark:bg-[#09090B]">
                                <div className="flex justify-between font-bold text-slate-800 dark:text-white">
                                    <span>প্রোডাক্ট: {selectedColor} বোরকা ({selectedType === 'combo' ? 'ফুল কম্বো সেট' : selectedType === 'ma_single' ? 'সিঙ্গেল বোরকা (মা)' : selectedType === 'baby_single' ? 'সিঙ্গেল বোরকা (বাচ্চা)' : 'হিজাব'})</span>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed dark:text-zinc-300">
                             ...
                             <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full bg-slate-100 text-slate-800 dark:text-white py-4 rounded font-bold text-xl hover:bg-slate-200 transition-all active:scale-95 dark:bg-[#09090B]"
                                >
                                    ঠিক আছে
                                </button>
